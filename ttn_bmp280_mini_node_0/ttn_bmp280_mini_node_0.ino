...
int sleepcycles = 15;  // (EJD) every sleepcycle will last 8 secs, total sleeptime will be sleepcycles * 8 sec
bool joined = false;
bool sleeping = false;
...
static const u1_t APPKEY[16] = { 0xE8, 0x6C, 0x0E, 0x25, 0x11, 0x59, 0x86, 0x7C, 0x22, 0x23, 0x5E, 0xC9, 0xC5, 0xDC, 0xE5, 0x44 };
